 ...
 * @author wty
 */
public class TextFieldAddHandle implements Handle<CSearchPipeFieldContext, IndexableField> {
    ...
    public boolean support(CSearchPipeFieldContext context) {
        ...
        return addContext.getEnums().equals(CFieldPipeTypeEnum.TEXT_FIELD);
    }
