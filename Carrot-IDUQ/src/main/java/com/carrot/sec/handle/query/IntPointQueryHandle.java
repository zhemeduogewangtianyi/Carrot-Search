 ...
 * @author wty
 */
public class IntPointQueryHandle implements Handle<CSearchPipeFieldContext, Boolean> {
    ...
    public Boolean handle(CSearchPipeFieldContext context) {
        ...
        if(fieldValue != null){
            ...
            Query query = IntPoint.newExactQuery(name, Integer.parseInt(fieldValue.toString()));
    ...
    public boolean support(CSearchPipeFieldContext context) {
        ...
        return queryContext.getEnums().equals(CFieldPipeTypeEnum.INT_POINT);
    }
