...
public class ResultSet implements java.sql.ResultSet {
    ...
    private ConcurrentHashMap<String, Object> currentMap;

    private final Queue<Map<String, Object>> item;
    ...
    public boolean next() throws SQLException {
        try{
            Map<String, Object> poll = item.poll();
            if (poll != null) {
                this.currentMap = new ConcurrentHashMap<>(poll);
            }
            return poll != null;
        }catch(Exception e){
